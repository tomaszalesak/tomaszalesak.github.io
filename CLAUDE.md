...
src/
  ...
  components/
    ...
    about.tsx       — intro + skill-area highlights (Radix DataList)
    services.tsx    — service offering cards with check-mark lists
    how-i-work.tsx  — work principles in a 2-column accent grid
